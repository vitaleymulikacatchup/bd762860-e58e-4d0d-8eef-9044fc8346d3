...
export const metadata: Metadata = {
  title: "Bella Pizza - Authentic Italian Pizzeria Since 1985",
  description: "Experience authentic Italian wood-fired pizzas made with traditional recipes and finest imported ingredients. Family-owned pizzeria serving delicious pizza for over 35 years.",
  keywords: "italian pizza, wood fired pizza, authentic pizzeria, italian restaurant, margherita pizza, pepperoni pizza",
  metadataBase: new URL("https://bellapizza.com"),
  alternates: {
    canonical: "https://bellapizza.com"
  },
  openGraph: {
    title: "Bella Pizza - Authentic Italian Pizzeria Since 1985",
    description: "Experience authentic Italian wood-fired pizzas made with traditional recipes and finest imported ingredients.",
    ...
    images: [
      {
        ...
        alt: "Delicious wood-fired pizza fresh from the oven"
      }
    ]
  },
  twitter: {
